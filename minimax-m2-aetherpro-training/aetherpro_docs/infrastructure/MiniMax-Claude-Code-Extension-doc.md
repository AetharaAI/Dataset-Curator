...
1. Visit the [MiniMax Developer Platform](https://platform.minimax.io/user-center/basic-information/interface-key)
...
1. Edit or create the Claude Code configuration file located at `~/.claude/settings.json`. In this file, add or update the `env` field as shown below. Set `MINIMAX_API_KEY` to the API key obtained from the [MiniMax Developer Platform](https://platform.minimax.io/user-center/basic-information/interface-key).
...
2. Expand the **"API Keys"** section and configure the API information:
   ...
   * Enter the MiniMax base URL: [https://api.minimax.io/v1](https://api.minimax.io/v1)
3. Paste the API key obtained from the [MiniMax Developer Platform](https://platform.minimax.io/user-center/basic-information/interface-key) into the OpenAI API Key field.
...
Visit the [OpenRouter Integrations page](https://openrouter.ai/settings/integrations) and configure the MiniMax integration with the API key obtained from the [MiniMax Developer Platform](https://platform.minimax.io/user-center/basic-information/interface-key).

3. **Add Model in Trae**

a. Click the "**Add Model**" button

<img src="https://filecdn.minimax.chat/public/28fb795a-5851-4433-a314-331654d40ea5.png" width="60%" />

b. Select "**OpenRouter**" as the service provider and enter your OpenRouter API key

<img src="https://filecdn.minimax.chat/public/f4ff1e09-d210-4536-9591-b0226e0c76ae.png" width="60%" />
...
4. In **MiniMax API Key**, enter the API key from the [MiniMax Developer Platform](https://platform.minimax.io/user-center/basic-information/interface-key).
...
6. Enable the **"Edit"** option box in **"Auto-approve"** section and start using **"MiniMax-M2"** for development.
...
2. Under **API Provider**, select **MiniMax**.
3. In **MiniMax Entrypoint**, select "api.minimax.io".
4. In **MiniMax API Key**, enter the API key from the [MiniMax Developer Platform](https://platform.minimax.io/user-center/basic-information/interface-key).
...
1. Set the base URL and API key using environment variables. Use the API key obtained from the [**MiniMax Developer Platform**](https://platform.minimax.io/user-center/basic-information/interface-key) as the value for `MINIMAX_API_KEY`.
...
2. Set the API key using environment variables in the current terminal session for security reasons. Use the API key obtained from the [**MiniMax Developer Platform**](https://platform.minimax.io/user-center/basic-information/interface-key) as the value for `MINIMAX_API_KEY`.
...
1. Use following command to edit the configuration file located at `~/.factory/config.json`. Set `MINIMAX_API_KEY` to the API key obtained from the [MiniMax Developer Platform](https://platform.minimax.io/user-center/basic-information/interface-key).
...
1. Edit or create the OpenCode configuration file located at `~/.config/opencode/opencode.json`. In this file, add or update the env field as shown below. Set `MINIMAX_API_KEY` to the API key obtained from the [MiniMax Developer Platform](https://platform.minimax.io/user-center/basic-information/interface-key).
...
2. Confirm that you have replaced `<MINIMAX_API_KEY>` with your API key from [MiniMax Developer Platform](https://platform.minimax.io/user-center/basic-information/interface-key)..
